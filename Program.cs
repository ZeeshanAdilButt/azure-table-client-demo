    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           CloudStorageAccount storageAccount = CloudStorageAccount.Parse(
            ...
            try
            {
                ...
                customer1.Email = "jay@contoso.com";
                ...
                CloudTable peopleTable = tableClient.GetTableReference("Employees");
                ...
                Console.WriteLine($"Patititon key is: {customer1.PartitionKey}");
        ...
        static string GetAccountSASToken()
        {
            ...
            SharedAccessAccountPolicy policy = new SharedAccessAccountPolicy()
            {
                ...
                SharedAccessExpiryTime = DateTime.UtcNow.Add(new TimeSpan(6, 15, 0)),
